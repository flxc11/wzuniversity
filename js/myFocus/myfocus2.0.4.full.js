...
//定义myFocus全局变量
window.myFocus = function(settings){
...
myFocus.fn.extend({//Method(fn)
    ...
    play:function(funcLastFrame,funcCurrentFrame,seamless){
        ...
        if(!p.wrap) this_.parent().find(".loading").fadeOut(300)
        else this_.find('.loading').remove();//删除loading...
        ...
        $btnList.each(function(i){
            ...
            if(type==='click'){
                ...
                $o.bind('mouseover',function(){
                    ...
                    console.log($btnList.mouseoverTimer);
                }).bind('mouseout',function(){
...
myFocus.extend({//Init
    ...
    getFilePath:function(){
        ...
        if(typeof define=="function" && define.cmd){
            return path.slice(0,path.lastIndexOf('/')+1)+"myFocus/";
        }else{
